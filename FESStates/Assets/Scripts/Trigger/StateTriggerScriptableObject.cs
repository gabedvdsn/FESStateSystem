...
public class StateTriggerScriptableObject : AbstractStateTriggerScriptableObject
{
    ...
    public override bool Activate(StateActor actor)
    {
        ...
        {
            // If not forcing moderator change and the override moderator priority is less than current moderator
            if (!ForceOverrideModerator && OverrideModerator.ModeratorPriority > actor.Moderator.BaseModerator.ModeratorPriority)
            {
